...
module.exports.initRouter = function initRouter(app) {
  ...
  app.get('/caretakers/:user/advertisement', get_caretaker_advertisement);  //gets no. of (RATED) past jobs, av rating
  app.get('/caretakers/:user/advertisement/ratings', get_caretaker_ratings); //shows all ratings
  app.get('/caretakers/:user/advertisement/ratings/top5', get_caretaker_top_five_ratings);
  app.get('/caretakers/:animal_name', get_caretakers_by_pet_type);
